...
import net.llm.block.custom.entity.ExtractorBlockEntity;
...
public class ExtractorBlock
    ...
    public ExtractorBlock(Settings settings) {        super(settings);    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        ...
        BlockEntity blockEntity = world.getBlockEntity(pos);
        if (blockEntity instanceof ExtractorBlockEntity) {
            ItemScatterer.spawn(world, pos, (Inventory)((ExtractorBlockEntity)blockEntity));
        }
