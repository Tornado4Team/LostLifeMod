...
public class CleaningTableScreenHandler
    ...
    public CleaningTableScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(5), new ArrayPropertyDelegate(2));
    }

    public CleaningTableScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate) {
        super(ScreenHandlerType.BREWING_STAND, syncId);
        int i;
        CleaningTableScreenHandler.checkSize(inventory, 5);
        CleaningTableScreenHandler.checkDataCount(propertyDelegate, 2);
        this.inventory = inventory;
        this.propertyDelegate = propertyDelegate;
        this.addSlot(new CleaningTableScreenHandler.PotionSlot(inventory, 0, 56, 51));
        this.addSlot(new CleaningTableScreenHandler.PotionSlot(inventory, 1, 79, 58));
        this.addSlot(new CleaningTableScreenHandler.PotionSlot(inventory, 2, 102, 51));
        this.ingredientSlot = this.addSlot(new CleaningTableScreenHandler.IngredientSlot(inventory, 3, 79, 17));
        this.addSlot(new CleaningTableScreenHandler.FuelSlot(inventory, 4, 17, 17));
    ...
    static class PotionSlot
        ...
        public boolean canInsert(ItemStack stack) {
            return CleaningTableScreenHandler.PotionSlot.matches(stack);
        }
    ...
    static class FuelSlot
        ...
        @Override
        public boolean canInsert(ItemStack stack) {
            return CleaningTableScreenHandler.FuelSlot.matches(stack);
        }
