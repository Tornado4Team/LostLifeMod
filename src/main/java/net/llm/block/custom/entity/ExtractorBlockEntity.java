...
import net.llm.block.custom.screen.ExtractorScreenHandler;
...
public class ExtractorBlockEntity
    ...
    protected final PropertyDelegate propertyDelegate = new PropertyDelegate(){
        ...
        public int get(int index) {
            switch (index) {
                case 0: {
                    return ExtractorBlockEntity.this.brewTime;
                }
                case 1: {
                    return ExtractorBlockEntity.this.fuel;
                }
            }
            return 0;
        }
        ...
        public void set(int index, int value) {
            switch (index) {
                case 0: {
                    ExtractorBlockEntity.this.brewTime = value;
                    break;
                }
                case 1: {
                    ExtractorBlockEntity.this.fuel = value;
                }
            }
        }
