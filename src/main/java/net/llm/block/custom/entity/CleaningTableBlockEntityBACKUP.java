...
public class CleaningTableBlockEntityBACKUP
    ...
    protected final PropertyDelegate propertyDelegate = new PropertyDelegate(){
        ...
        public int get(int index) {
            switch (index) {
                case 0: {
                    return CleaningTableBlockEntityBACKUP.this.brewTime;
                }
                case 1: {
                    return CleaningTableBlockEntityBACKUP.this.fuel;
                }
            }
            return 0;
        }
        ...
        public void set(int index, int value) {
            switch (index) {
                case 0: {
                    CleaningTableBlockEntityBACKUP.this.brewTime = value;
                    break;
                }
                case 1: {
                    CleaningTableBlockEntityBACKUP.this.fuel = value;
                }
            }
        }
    ...
    public CleaningTableBlockEntityBACKUP(BlockPos pos, BlockState state) {
    ...
    public static void tick(World world, BlockPos pos, BlockState state, CleaningTableBlockEntityBACKUP blockEntity) {
        ItemStack itemStack = blockEntity.inventory.get(4);
        if (blockEntity.fuel <= 0 && itemStack.isOf(Items.BLAZE_POWDER)) {
            blockEntity.fuel = 20;
            itemStack.decrement(1);
            CleaningTableBlockEntityBACKUP.markDirty(world, pos, state);
        }
        boolean bl = CleaningTableBlockEntityBACKUP.canCraft(blockEntity.inventory);
        ...
        if (bl2) {
            ...
            if (bl3 && bl) {
                CleaningTableBlockEntityBACKUP.craft(world, pos, blockEntity.inventory);
                CleaningTableBlockEntityBACKUP.markDirty(world, pos, state);
