...
import net.llm.block.custom.screen.AnalyserScreenHandler;
...
public class AnalyserBlockEntity
    ...
    protected final PropertyDelegate propertyDelegate = new PropertyDelegate(){
        ...
        public int get(int index) {
            switch (index) {
                case 0: {
                    return AnalyserBlockEntity.this.brewTime;
                }
                case 1: {
                    return AnalyserBlockEntity.this.fuel;
                }
            }
            return 0;
        }
        ...
        public void set(int index, int value) {
            switch (index) {
                case 0: {
                    AnalyserBlockEntity.this.brewTime = value;
                    break;
                }
                case 1: {
                    AnalyserBlockEntity.this.fuel = value;
                }
            }
        }
    ...
    public static void tick(World world, BlockPos blockPos, BlockState state, AnalyserBlockEntity entity) {
        if(world.isClient()) {
            return;
        }
    ...
    private static void craftItem(AnalyserBlockEntity entity) {
    ...
    private static boolean hasRecipe(AnalyserBlockEntity entity) {
        SimpleInventory inventory = new SimpleInventory(entity.size());
        for (int i = 0; i < entity.size(); i++) {
            inventory.setStack(i, entity.getStack(i));
        }
    ...
    protected ScreenHandler createScreenHandler(int syncId, PlayerInventory playerInventory) {
        return new AnalyserScreenHandler(syncId, playerInventory, this, this.propertyDelegate);
    }
}
