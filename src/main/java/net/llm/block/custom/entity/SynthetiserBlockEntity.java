...
public class SynthetiserBlockEntity
    ...
    protected final PropertyDelegate propertyDelegate = new PropertyDelegate(){
        ...
        public int get(int index) {
            switch (index) {
                case 0: {
                    return SynthetiserBlockEntity.this.brewTime;
                }
                case 1: {
                    return SynthetiserBlockEntity.this.fuel;
                }
            }
            return 0;
        }
        ...
        public void set(int index, int value) {
            switch (index) {
                case 0: {
                    SynthetiserBlockEntity.this.brewTime = value;
                    break;
                }
                case 1: {
                    SynthetiserBlockEntity.this.fuel = value;
                }
            }
        }
    ...
    public static void tick(World world, BlockPos blockPos, BlockState state, SynthetiserBlockEntity entity) {
        if(world.isClient()) {
            return;
        }
    ...
    private static void craftItem(SynthetiserBlockEntity entity) {
    ...
    private static boolean hasRecipe(SynthetiserBlockEntity entity) {
        SimpleInventory inventory = new SimpleInventory(entity.size());
        for (int i = 0; i < entity.size(); i++) {
            inventory.setStack(i, entity.getStack(i));
        }
    ...
    protected ScreenHandler createScreenHandler(int syncId, PlayerInventory playerInventory) {
        return new SynthetiserScreenHandler(syncId, playerInventory, this, this.propertyDelegate);
    }
}
